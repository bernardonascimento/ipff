  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden bg-primary text-primary-foreground">
        <div
          aria-hidden
          className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_70%_60%_at_85%_-20%,_oklch(0.58_0.11_150_/_0.5),_transparent_60%)]"
        />
        <div
          aria-hidden
        ...
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-28 sm:px-6 md:pb-20 md:pt-36">
          <SectionLabel index="—" light>
            Programação
          </SectionLabel>
          <h1 className="animate-rise mt-6 max-w-3xl font-heading text-5xl font-light leading-[1.02] tracking-tight sm:text-6xl">
            Agenda da igreja
          </h1>
